...
- **User story 4**: As a user, I want to be able to add background music to my game to make the game more atmospheric.
- **User story 5**: As a user, I want to be able to test my game before releasing / publishing it.
- **User story 6**: As a user, I want to save my games so that I can continue working on it later
